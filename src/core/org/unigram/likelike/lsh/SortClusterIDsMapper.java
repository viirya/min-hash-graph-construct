 ...
 */
public class SortClusterIDsMapper extends
     ...
     * map.
     * @param key dummy
     * @param value containing cluster id and the image ids
    ...
    public final void map(final LongWritable key,
        ...
        try {
            ...
            String images = cluster_id_tokenizer.nextToken();

            context.write(new Text("CLUSTERS"), new Text(cluster_id));
